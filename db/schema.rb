...
ActiveRecord::Schema.define(version: 2023_06_24_092459) do
  ...
  create_table "cart_equipments", force: :cascade do |t|
  ...
  create_table "genres", force: :cascade do |t|
    t.string "equipment_genre", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "user_application_details", force: :cascade do |t|
